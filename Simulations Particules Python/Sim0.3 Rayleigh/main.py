...
balls=generateBallsSquareInGrid(grid,dimensions,4860,Vector2(0,0),Vector2(WIDTH,HEIGHT/2),1,BALLS_RADIUS,Vector2(0,0))
balls+=generateBallsSquareInGrid(grid,dimensions,4860,Vector2(0,HEIGHT/2),Vector2(WIDTH,HEIGHT),1,BALLS_RADIUS,Vector2(0,0))

addRandomSpeedsToBalls(balls,0.1)
print("numb of balls:",len(balls))

dataFile=resetAndOpenDataFile("Sim0.3 Rayleigh/Data/data.txt")
