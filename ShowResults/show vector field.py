...
velXDataSetIndexes=getDataSetIndexesInDataFile("ShowResults/xVelParticleAV.txt")
velYDataSetIndexes=getDataSetIndexesInDataFile("ShowResults/yVelParticleAV.txt")
#DensityDataSetIndexes=getDataSetIndexesInDataFile("ShowResults/densitydata2.txt")
frameIndex=400
print(len(velXDataSetIndexes))

u=readDataInInterval("ShowResults/xVelParticleAV.txt",velXDataSetIndexes[frameIndex],velXDataSetIndexes[frameIndex+1])
v=readDataInInterval("ShowResults/yVelParticleAV.txt",velYDataSetIndexes[frameIndex],velYDataSetIndexes[frameIndex+1])
...
plt.quiver(x.flatten(), y.flatten(), u.flatten(), v.flatten(), color=colors.reshape(-1, 4), scale=30,linewidths=1)
